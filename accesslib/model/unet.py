...
def create_model_filter_division_2(n_classes=3, img_height=320, img_width=320, img_channels=1, verbose=True):
    """
    :return:
    """
    """
    ...
    # Expansive path
    u6 = Conv2DTranspose(filters=64, kernel_size=(2, 2), strides=(2, 2))(c5)
    u6 = concatenate([u6, c4])
    ...
    u7 = Conv2DTranspose(filters=32, kernel_size=(2, 2), strides=(2, 2))(c6)
    u7 = concatenate([u7, c3])
    ...
    u8 = Conv2DTranspose(filters=16, kernel_size=(2, 2), strides=(2, 2))(c7)
    u8 = concatenate([u8, c2])
    ...
    u9 = Conv2DTranspose(filters=8, kernel_size=(2, 2), strides=(2, 2))(c8)
    u9 = concatenate([u9, c1])
